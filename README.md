# NOTE: I Didn't make this, this is just a mirror

Mirrored from here: https://code.garrettmills.dev/garrettmills/archive-posy-cursors

## Using bswpwm?

To easily set cursor, add this to your .bspwmrc

`xsetroot -xcf /usr/share/icons/posy-white/cursors/left_ptr 24`
...
Copy `posy-*` folders to `/usr/share/icons` also
